...
<h3 align="center">Talker-Manager</h3>
  ...
  <p align="center">
    Projeto com base em uma aplicação de cadastro de palestrantes
    <br />
  </p>
</div>
...
Foi construída uma aplicação de cadastro de talkers (palestrantes) em que é possível cadastrar, visualizar, pesquisar, editar e excluir informações. Para isso foi desenvolvído:

Uma API de um CRUD (Create, Read, Update e Delete) de palestrantes (talkers) e;
Alguns endpoints que leem e escrevem um arquivo utilizando o módulo fs.
...
1. Clone o repositório
  ...
  - Use o comando: 
   ```sh
   git clone git@github.com:Lucdomingues/Talker-Manager.git
   ```
...
<!-- https://www.markdownguide.org/basic-syntax/#reference-style-links -->
[contributors-shield]: https://img.shields.io/github/contributors/Lucdomingues/Talker-Manager.svg?style=for-the-badge
[contributors-url]: https://github.com/Lucdomingues/Talker-Manager/graphs/contributors
